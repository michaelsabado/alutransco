...
<body>
    ...
    <div class="container pt-5">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12 col-12">
                ...
                <div class="display-5 fw-bold mb-4">Deductions</div>

                <div class="menu">

                    <a class="h6 py-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Deduction <i class="fas fa-plus-circle float-end"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title" id="exampleModalLabel">Deduction Details</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="" id="add-form">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-5">
                                <div class="h6 pt-2">Description</div>
                            </div>
                            <div class="col-md-7">
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title" id="exampleModalLabel1">Deduction Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            function load_data() {
                $('#ajax-result').load('ajax/deductions');
            }
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                position: 'top-end',
                                icon: 'success',
                                title: 'Deduction Details Updated',
